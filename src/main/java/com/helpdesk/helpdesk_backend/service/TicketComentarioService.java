...
public interface TicketComentarioService {
    ...
    List<ComentarioResponseDTO> listarPorUsuario(Long usuarioId, Long empresaIdContexto);
    List<ComentarioResponseDTO> buscarPorTexto(String texto, Long empresaIdContexto);
