...
public class ProblemaTicketRepositoryTest {
        ...
        void findAllByCategoriaIdAndActivoTrue_DebeRetornarSoloProblemasActivosDeLaCategoria() {
                List<ProblemaTicket> resultado = problemaRepository
                                .findAllByCategoriaIdAndActivoTrue(categoria1.getId());
        ...
        @Test
        void findAllByCategoriaIdAndActivoTrue_CuandoNoHayActivos_DebeRetornarListaVacia() {

                // Buscar una categoría inexistente
                List<ProblemaTicket> resultado = problemaRepository
                                .findAllByCategoriaIdAndActivoTrue(999L);
        ...
        @Test
        void existsByNombreAndCategoriaId_CuandoNoExiste_DebeRetornarFalse() {

                // Nombre inexistente
                boolean existe = problemaRepository
                                .existsByNombreAndCategoriaId(
                                                "Problema Fantasma",
                                                categoria1.getId());
        ...
        void existsByNombreAndCategoriaId_DebeValidarCorrectamenteLaExistenciaEnLaMismaCategoria() {
                boolean existeEnCat1 = problemaRepository.existsByNombreAndCategoriaId("Pantalla Rota",
                                categoria1.getId());
                boolean existeEnCat2 = problemaRepository.existsByNombreAndCategoriaId("Pantalla Rota",
                                categoria2.getId());
